...
void array2DFilling(int realClasses[], int estimateClasses[], int resultsPerClass[NB_MOVEMENTS][NB_MOVEMENTS], int nbTests);
void resultsForEachClasses(int theoricalAppearencePerClass[], int correctResultsPerClass[], int resultsPerClass[NB_MOVEMENTS][NB_MOVEMENTS]);
...
void displayClass(int theoricalAppearencePerClass[], int resultsPerClass[NB_MOVEMENTS][NB_MOVEMENTS]);
