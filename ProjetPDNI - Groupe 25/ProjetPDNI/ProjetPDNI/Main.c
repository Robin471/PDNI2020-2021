...
void main(void) {
	...
	printf("Create Models\n");
	createModels();

	// ==========   PARTIE ÉVALUATION DU TESTSET APD DES MODELES   ===================
	printf("Test of testSet.csv\n");
	testSetEvaluation();

	// ==========   PARTIE REMPLISSAGE DE REALCLASSES ET ESTIMATECLASSES (VALEURS FICTIVES)  ===================
